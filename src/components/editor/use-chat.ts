...
// // COLLABORATIVE FEATURES DISABLED - Remove comment from available tools
// export type ToolName = 'edit' | 'generate'; // removed 'comment'

// // COLLABORATIVE FEATURES DISABLED - Comment out comment types
...
//       // COLLABORATIVE FEATURES DISABLED - Comment out AI comment handling
...
//         // COLLABORATIVE FEATURES DISABLED - Comment out comment sample
//         // if (sample === 'comment') {
...
// // COLLABORATIVE FEATURES DISABLED - Comment out createCommentChunks function
